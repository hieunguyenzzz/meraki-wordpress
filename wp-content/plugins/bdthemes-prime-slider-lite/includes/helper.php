<?php
    ...
    define('BDTPS', ''); //Add prefix for all widgets
    define('BDTPS_CP', '<span class="bdt-ps-widget-badge"></span>'); // if you have any custom style
    define('BDTPS_SLUG', 'prime-slider'); // set your own alias
    define('BDTPS_TITLE', 'Prime Slider'); // Set your own name for plugin
    if ( !defined('BDTPS_NC') ) {
