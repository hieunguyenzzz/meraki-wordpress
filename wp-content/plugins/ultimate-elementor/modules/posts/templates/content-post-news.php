...
<div class="uael-post-wrapper <?php echo $this->get_masonry_classes(); ?> <?php echo ( $is_featured && 1 < $query->post_count ) ? 'uael-post-wrapper-featured' : ''; ?> <?php echo $this->get_category_name(); ?>">
